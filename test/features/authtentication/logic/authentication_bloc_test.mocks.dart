...
// in eimunisasi/test/features/authtentication/logic/authentication_bloc_test.dart.
...
import 'package:eimunisasi/features/splash/data/repositories/splash_repository.dart'
    as _i9;
import 'package:eimunisasi/models/user.dart' as _i7;
...
class MockAuthRepository extends _i1.Mock implements _i5.AuthRepository {
  ...
  @override
  _i6.Future<void> logInWithEmailAndPassword({
  ...
  @override
  _i6.Future<void> forgetEmailPassword({required String? email}) =>
      (super.noSuchMethod(
        Invocation.method(
          #forgetEmailPassword,
          [],
  ...
  @override
  _i6.Future<_i3.UserCredential> signUpWithOTP(
    dynamic smsCode,
    dynamic verId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> insertUserToDatabase({required _i7.Users? user}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<bool> isUserExist() => (super.noSuchMethod(
        Invocation.method(
          #isUserExist,
          [],
        ),
  ...
  @override
  _i6.Future<_i7.Users?> getUser() => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [],
        ),
        returnValue: _i6.Future<_i7.Users?>.value(),
      ) as _i6.Future<_i7.Users?>);
  @override
  _i6.Future<void> updateUserAvatar(String? url) => (super.noSuchMethod(
        Invocation.method(
          #updateUserAvatar,
          [url],
        ),
  ...
  @override
  _i6.Future<String> uploadImage(_i8.File? imageFile) => (super.noSuchMethod(
        Invocation.method(
          #uploadImage,
          [imageFile],
        ),
  ...
  @override
  _i6.Future<dynamic> destroyPasscode() => (super.noSuchMethod(
        Invocation.method(
          #destroyPasscode,
          [],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSplashRepository extends _i1.Mock implements _i9.SplashRepository {
  ...
  @override
  _i6.Future<bool> isSeen() => (super.noSuchMethod(
        Invocation.method(
          #isSeen,
          [],
        ),
