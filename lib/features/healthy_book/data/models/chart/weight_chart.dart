import 'package:eimunisasi/features/healthy_book/data/models/chart/weight_chart_data_boy.dart';
import 'package:eimunisasi/features/healthy_book/data/models/chart/weight_chart_data_girl.dart.dart';
...
class _LineChart extends StatelessWidget {
  ...
  LineTouchData get lineTouchData2 => LineTouchData(
        ...
        touchTooltipData: LineTouchTooltipData(
          getTooltipColor: (LineBarSpot touchedBarSpot) => Colors.white,
  ...
  LineChartBarData get lineChartBarData2_1 => LineChartBarData(
        ...
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine1()
            : WeightChartDataGirl().listDataLine1(),
      );
  ...
  LineChartBarData get lineChartBarData2_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine2()
            : WeightChartDataGirl().listDataLine2(),
      );
  ...
  LineChartBarData get lineChartBarData2_3 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine3()
            : WeightChartDataGirl().listDataLine3(),
      );
  ...
  LineChartBarData get lineChartBarData2_4 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine4()
            : WeightChartDataGirl().listDataLine4(),
      );
  ...
  LineChartBarData get lineChartBarData2_5 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine5()
            : WeightChartDataGirl().listDataLine5(),
      );
  ...
  LineChartBarData get lineChartBarData2_6 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine6()
            : WeightChartDataGirl().listDataLine6(),
      );
  ...
  LineChartBarData get lineChartBarData2_7 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataLine7()
            : WeightChartDataGirl().listDataLine7(),
      );
  ...
  LineChartBarData get lineChartDataPasien => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? WeightChartDataBoy().listDataPasienLine(listData!)
            : WeightChartDataGirl().listDataPasienLine(listData!),
      );
}
