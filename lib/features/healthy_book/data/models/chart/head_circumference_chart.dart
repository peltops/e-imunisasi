...
import 'head_circumference_chart_data_boy.dart';
import 'head_circumference_chart_data_girl.dart';
...
class _LineChart extends StatelessWidget {
  ...
  LineChartBarData get lineChartBarData_1 => LineChartBarData(
        ...
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine1()
            : HeadCircumferenceChartDataGirl().listDataLine1(),
      );
  ...
  LineChartBarData get lineChartBarData_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine2()
            : HeadCircumferenceChartDataGirl().listDataLine2(),
      );
  ...
  LineChartBarData get lineChartBarData_3 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine3()
            : HeadCircumferenceChartDataGirl().listDataLine3(),
      );
  ...
  LineChartBarData get lineChartBarData_4 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine4()
            : HeadCircumferenceChartDataGirl().listDataLine4(),
      );
  ...
  LineChartBarData get lineChartBarData_5 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine5()
            : HeadCircumferenceChartDataGirl().listDataLine5(),
      );
  ...
  LineChartBarData get lineChartBarData_6 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine6()
            : HeadCircumferenceChartDataGirl().listDataLine6(),
      );
  ...
  LineChartBarData get lineChartBarData_7 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataLine7()
            : HeadCircumferenceChartDataGirl().listDataLine7(),
      );
  ...
  LineChartBarData get lineChartDataPasien => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeadCircumferenceChartDataBoy().listDataPasienLine(listData!)
            : HeadCircumferenceChartDataGirl().listDataPasienLine(listData!),
      );
}
