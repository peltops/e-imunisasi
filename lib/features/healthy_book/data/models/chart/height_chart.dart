...
import 'height_chart_data_boy.dart';
import 'height_chart_data_girl.dart';
...
class _LineChart extends StatelessWidget {
  ...
  LineChartBarData get lineChartBarData_1 => LineChartBarData(
        ...
        spots: (isBoy)
            ? HeightChartDataBoy().listDataLine1()
            : HeightChartDataGirl().listDataLine1(),
      );
  ...
  LineChartBarData get lineChartBarData_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeightChartDataBoy().listDataLine2()
            : HeightChartDataGirl().listDataLine2(),
      );
  ...
  LineChartBarData get lineChartBarData_3 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeightChartDataBoy().listDataLine3()
            : HeightChartDataGirl().listDataLine3(),
      );
  ...
  LineChartBarData get lineChartBarData_4 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeightChartDataBoy().listDataLine4()
            : HeightChartDataGirl().listDataLine4(),
      );
  ...
  LineChartBarData get lineChartBarData_5 => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeightChartDataBoy().listDataLine5()
            : HeightChartDataGirl().listDataLine5(),
      );
  ...
  LineChartBarData get lineChartDataPasien => LineChartBarData(
        ...
        belowBarData: BarAreaData(show: false),
        spots: (isBoy)
            ? HeightChartDataBoy().listDataPasienLine(listData!)
            : HeightChartDataGirl().listDataPasienLine(listData!),
      );
}
