...
class VaccinationRegisterScreen extends StatefulWidget {
  ...
  @override
  _VaccinationRegisterScreenState createState() =>
      _VaccinationRegisterScreenState();
}

class _VaccinationRegisterScreenState extends State<VaccinationRegisterScreen> {
  ...
  Widget build(BuildContext context) {
    final user = (context.read<AuthenticationBloc>().state as Authenticated).user;
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: () {
                        final jadwalImunisasi = widget.nakes.jadwalImunisasi;
                      ...
                      onPressed: isLoading
                          ...
                          : () {
                              ...
                              if (selectedRadioTile == null ||
                                ...
                                snackbarCustom('Lengkapi data terlebih dahulu!')
                                    .show(context);
                                return;
                              }
